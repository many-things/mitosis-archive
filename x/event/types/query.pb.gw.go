...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"many-things", "mitosis", "event", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_VoteStatus_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"many-things", "mitosis", "event", "vote_status"}, "", runtime.AssumeColonVerbOpt(true)))
)
