...
import (
	...
	eventsimulation "github.com/many-things/mitosis/x/event/simulation"
...
const (
	opWeightMsgVoteEvent = "op_weight_msg_vote_event"
	// TODO: Determine the simulation weight value
	defaultWeightMsgVoteEvent int = 100
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	eventGenesis := types.GenesisState{
		Params: types.DefaultParams(),
		// this line is used by starport scaffolding # simapp/module/genesisState
	}
	simState.GenState[types.ModuleName] = simState.Cdc.MustMarshalJSON(&eventGenesis)
}
