...
type Operation struct {
	...
	TxPayload     []byte           `protobuf:"bytes,6,opt,name=tx_payload,json=txPayload,proto3" json:"tx_payload,omitempty"`
	TxBytesToSign []byte           `protobuf:"bytes,7,opt,name=tx_bytes_to_sign,json=txBytesToSign,proto3" json:"tx_bytes_to_sign,omitempty"`
	SigID         uint64           `protobuf:"varint,8,opt,name=sig_id,json=sigId,proto3" json:"sig_id,omitempty"`
	Result        *OperationResult `protobuf:"bytes,9,opt,name=result,proto3" json:"result,omitempty"`
}
...
func (m *Operation) GetSignerPubkey() []byte {
	if m != nil {
...
var fileDescriptor_16d3fd8510e89a44 = []byte{
	...
	,
}
...
func (m *Operation) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SignerPubkey) > 0 {
		...
		i = encodeVarintTypesOperation(dAtA, i, uint64(len(m.SignerPubkey)))
		i--
		dAtA[i] = 0x2a
	}
	if m.Status != 0 {
