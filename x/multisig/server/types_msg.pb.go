...
type MsgStartSign struct {
	...
	KeyID         github_com_many_things_mitosis_x_multisig_exported.PublicKey            `protobuf:"bytes,3,opt,name=key_id,json=keyId,proto3,casttype=github.com/many-things/mitosis/x/multisig/exported.PublicKey" json:"key_id,omitempty"`
	PubKeys       map[string]github_com_many_things_mitosis_x_multisig_exported.PublicKey `protobuf:"bytes,4,rep,name=pub_keys,json=pubKeys,proto3,castvalue=github.com/many-things/mitosis/x/multisig/exported.PublicKey" json:"pub_keys,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	MessageToSign github_com_many_things_mitosis_x_multisig_exported.Hash                 `protobuf:"bytes,5,opt,name=message_to_sign,json=messageToSign,proto3,casttype=github.com/many-things/mitosis/x/multisig/exported.Hash" json:"message_to_sign,omitempty"`
...
func (m *MsgStartSign) GetKeyID() github_com_many_things_mitosis_x_multisig_exported.PublicKey {
	if m != nil {
		return m.KeyID
	}
	return ""
...
func (m *MsgStartSign) GetPubKeys() map[string]github_com_many_things_mitosis_x_multisig_exported.PublicKey {
	if m != nil {
		return m.PubKeys
	}
	return nil
...
func (m *MsgStartSign) GetMessageToSign() github_com_many_things_mitosis_x_multisig_exported.Hash {
	if m != nil {
...
func (m *MsgSubmitSignature) GetSignature() Signature {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]github_com_many_things_mitosis_x_multisig_exported.PublicKey)(nil), "manythings.mitosis.v1beta1.multisig.server.MsgStartSign.PubKeysEntry")
...
var fileDescriptor_b9d7fa7963eb62b7 = []byte{
	...
	,
}
...
func (m *MsgStartSign) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.KeyID = github_com_many_things_mitosis_x_multisig_exported.PublicKey(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
			...
			if m.PubKeys == nil {
				m.PubKeys = make(map[string]github_com_many_things_mitosis_x_multisig_exported.PublicKey)
			}
			var mapkey string
			mapvalue := []byte{}
			for iNdEx < postIndex {
			...
			m.PubKeys[mapkey] = ((github_com_many_things_mitosis_x_multisig_exported.PublicKey)(mapvalue))
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
