...
var (
	filter_Query_Proxy_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func request_Query_Proxy_0(ctx context.Context, marshaler runtime.Marshaler, client QueryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_Query_Proxy_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
var (
<<<<<<<< HEAD:x/event/server/server.pb.gw.go
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"many-things", "mitosis", "event", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_VoteStatus_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"many-things", "mitosis", "event", "vote_status"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Proxy_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"many-things", "mitosis", "event", "proxy"}, "", runtime.AssumeColonVerbOpt(false)))
========
