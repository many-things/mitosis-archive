...
import (
	...
	"github.com/many-things/mitosis/docs"
)
...
func New(
	...
	*/
	...
	multisigModule := multisigmodule.NewAppModule(appCodec, app.MultisigKeeper, app.AccountKeeper, app.BankKeeper, app.EventKeeper)
